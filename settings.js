...
module.exports = {
SESSION_ID: process.env.SESSION_ID === undefined ? 'VAJIRA-MD=3UMWFJjL#6REKshmoWiO6kU4YTyrX6X70gWkmgLL3pevEPs_bzqQ' : process.env.SESSION_ID,
OWNER_NUMBER: process.env.OWNER_NUMBER === undefined ? '+923458806147' : process.env.OWNER_NUMBER,   
...
AUTO_VOICE:  process.env redAUTO_VOICE  || false  ,
